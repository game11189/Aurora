...
HD_PWD='/home/callie/Desktop/xilinxauroratest/project_1/project_1.runs/aurora_64b66b_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aurora_64b66b_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aurora_64b66b_0.tcl
